...
export const POWER_UP_DATA: Record<PowerUpId, PowerUp> = {
  "1": {
    ...
    exampleDescription: "example: Player asks 'Do you have three 6s?'. Opponent must answer 'Yes' or 'No'.",
    cardImage: Grill,
    isImageLarge: true,
  },
  "2": {
    ...
    exampleDescription: "example: Opponent has a 2, a 3 and a 6. They must answer with '11'.",
