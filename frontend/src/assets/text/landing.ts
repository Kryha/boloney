export const landing = {
  ...
  joinThe: "join the",
  takeTurnsToRoll:
    "take turns to roll your dice and call actions. Play power-ups to spread shockwaves and see who's bluffing and who's for real. But don't let the clock run out, 'cause you'll lose a die.",
