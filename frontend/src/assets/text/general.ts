export const general = {
  ...
  cookieBannerTitle: "no boloney was used in the making of these cookies",
  cookieBannerPreHyperLink: "we use analytics cookies to understand how you use Boloney! and to make improvements. Check our ",
  cookieBannerAfterHyperLink: " for more details.",
  cookieBannerLinkText: "cookie policy",
