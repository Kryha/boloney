...
describe("getRange function", () => {
  it("Should return an array of size 10 with distinct elements in range [0,10)", () => {
...
describe("randomInt function", () => {
  ...
  it("Should return a random number between 0 and 0", () => {
    const maxValue = 0;
    const value = randomInt(maxValue);
    expect(value <= maxValue && value >= minValue);
  });

  it("Should return a random number between 8 and 10", () => {
    const maxValue = 10;
    const minValue = 8;
  ...
  it("Should return a random number between 10 and 9", () => {
    const maxValue = 9;
    const minValue = 10;
    const value = randomInt(maxValue, minValue);
    expect(value <= maxValue && value >= minValue);
